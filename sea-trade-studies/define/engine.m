...
% Modified 6/14/2016 to include Beta free piston engine

global engine_type % s)inusoidal, y)oke r)ocker-V, b)etadrive
...
function betadrive
% Free piston Beta drive engine configuration (assume sinusoidal motion)
...
vpa = xpa*(ap - ar); % (piston - rod) volume amplitute {m^3)
