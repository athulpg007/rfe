function [var,dvar,actWpower,actQhpower,acteff] = simple
...
% Temperature plot of the simple simulation results
		...
		y = [twh,twh];
		plot(x,y,'r--')
        legend({'Compression Space Temp', 'Expansion Space Temp', 'Cooler Wall Temp','Cooler Gas Temp', 'Regenerator Temp', 'Hot Gas Temp', 'Heater Wall Temp'},'Location','east')
		hold off
		grid on
